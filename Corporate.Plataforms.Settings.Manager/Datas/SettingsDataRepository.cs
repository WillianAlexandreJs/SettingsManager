...
namespace Corporate.Plataforms.Settings.Manager.Datas
{
    public class SettingsDataRepository : ISettingsDataRepository
    {
        ...
        {
            return _context.GetPropertiesData.FromSqlRaw("LIST_INSTANCE_PROPERTY_VALUES").ToList();
        }
        ...
        public TransactionCommandResult UpdateInstancePropertyData(string instanceName, PropertyDataUpdate propertyData)
        {
            ...
            return _context.GetTransactionCommandResult.FromSqlRaw("UPDATE_INSTANCE_PROPERTY_VALUE @INSTANCE_NAME, @PROPERTY_NAME, @SETTING_REFERENCE, @PROPERTY_VALUE, @PROPERTY_ID OUTPUT",
