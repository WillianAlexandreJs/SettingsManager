...
namespace Corporate.Plataforms.Settings.DevTools
{
    public partial class frmTestHubConnection : Form
    {
        ...
        private void StartHub(string instanceId)
        {
            ...
            applicationConfigHub.StartHubConnection(txtUrlHubConnection.Text, txtHubProxyName.Text, txtApplicationName.Text, instanceId, new TimeSpan(0, 0, 5), UpdateSettingApplication =>
              {
