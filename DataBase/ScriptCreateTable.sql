...
CREATE TABLE TB_INSTANCE_INTEGRATION (
	INSTANCE_INTEGRATION_ID	INT IDENTITY(1,1)				CONSTRAINT PK_INSTANCE_INTEGRATION PRIMARY KEY,
	...
	SERVER_INSTANCE_ID		INT					NULL	CONSTRAINT FK_SERVER_INSTANCE_INTEGRATION_INSTANCE FOREIGN KEY REFERENCES TB_INSTANCE(INSTANCE_ID),
	SERVER_PROPERTY_ID		INT					NULL	CONSTRAINT FK_SERVER_INSTANCE_INTEGRATION_PROPERTY FOREIGN KEY REFERENCES TB_PROPERTY(PROPERTY_ID),
	USER_CREATED VARCHAR(40)		NOT NULL,
...
CREATE TABLE TB_LIBRARY_PROPERTY (
	...
	LIBRARY_PROPERTY_NAME		VARCHAR(40)			NOT NULL	CONSTRAINT UN_LIBRARY_PROPERTY_NAME UNIQUE, 
